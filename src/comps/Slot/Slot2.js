...
function Slot() {
  ...
  function spin() {
    let numbergenerator1 = setInterval(() => {
      let nu1 = Math.floor(Math.random() * (5 + 1));
      let nu2 = Math.floor(Math.random() * (5 + 1));
      let nu3 = Math.floor(Math.random() * (5 + 1));
      setCol11(nu1);
      setCol12(nu2);
      setCol13(nu3);
      switch (nu1) {
    ...
    let numbergenerator2 = setInterval(() => {
      let nu4 = Math.floor(Math.random() * (5 + 1));
      let nu5 = Math.floor(Math.random() * (5 + 1));
      let nu6 = Math.floor(Math.random() * (5 + 1));
    ...
    let numbergenerator3 = setInterval(() => {
      let nu7 = Math.floor(Math.random() * (5 + 1));
      let nu8 = Math.floor(Math.random() * (5 + 1));
      let nu9 = Math.floor(Math.random() * (5 + 1));
    ...
    let numbergenerator4 = setInterval(() => {
      let nu10 = Math.floor(Math.random() * (5 + 1));
      let nu11 = Math.floor(Math.random() * (5 + 1));
      let nu12 = Math.floor(Math.random() * (5 + 1));
    ...
    let numbergenerator5 = setInterval(() => {
      let nu13 = Math.floor(Math.random() * (5 + 1));
      let nu14 = Math.floor(Math.random() * (5 + 1));
      let nu15 = Math.floor(Math.random() * (5 + 1));
    ...
    setTimeout(() => {
      ...
      // let no1 = Math.floor(Math.random() * (5 + 1));
